...
whichcontrast=[strcmp({aap.tasksettings.(modulename)(moduleindex).contrasts.subject},subject)];
if (~any(whichcontrast))
    ...
    aap.tasksettings.(modulename)(moduleindex).contrasts(end+1)=emptycon;
else
    
    aap.tasksettings.(modulename)(moduleindex).contrasts(whichcontrast).con(end+1).format=format;
    aap.tasksettings.(modulename)(moduleindex).contrasts(whichcontrast).con(end).vector=vector;
    aap.tasksettings.(modulename)(moduleindex).contrasts(whichcontrast).con(end).session=session;    
    aap.tasksettings.(modulename)(moduleindex).contrasts(whichcontrast).con(end).type=contype;    
    aap.tasksettings.(modulename)(moduleindex).contrasts(whichcontrast).con(end).name=conname;    
end;
