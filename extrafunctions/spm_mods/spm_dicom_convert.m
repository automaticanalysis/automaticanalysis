...
%
% Tibor Auer: 7T-compatible (lines 187-198)
% $Id: spm_dicom_convert.m 6456 2015-07-21 11:03:00Z tibor.auer@mrc-cbu.cam.ac.uk $
...
for i=1:length(hdr)
    ...
    %----------------------------------------------------------------------
    if checkfields(hdr{i},'AcquisitionTime','MagneticFieldStrength','MRAcquisitionType',...
