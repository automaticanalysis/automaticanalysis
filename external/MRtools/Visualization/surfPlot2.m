...
if ~isfield(obj,'colomap')
    obj.colomap = obj.colormap;
end
...
% t1 = unique(sort([obj.colorlims(1) mean(obj.colorlims) obj.colorlims(2) obj.overlaythresh])');
% ticklabel = round(t1*100)/100;

tickmark = [1 122 255];
t1 = [obj.colorlims(1) mean(obj.colorlims) obj.colorlims(2)]';
ticklabel = round(t1*100)/100;
