function fun_clsDKI(inputDWIfold,inputbvalfold,inputbvecfold,inputMaskfold)
...
[D11,D22,D33,D12,D13,D23,...
    ...
    fun_DKI_CLLS_comp_rh(DWI_data,DWI_mask,bval,bvec);
...
Fit_name=[pth, sc, nnname, '_clsDKI_KT.nii'];
...
Fit_name=[pth, sc, nnname, '_clsDKI_DT.nii'];
DTnii=V_DWI;
...
Fit_name=[pth, sc, nnname, '_clsDKI_S0.nii'];
S0nii=V_mask;
...
DTInii.img=DTI;
save_untouch_nii(DTInii,[pth, sc, nnname, '_clsDKI_DTorient.nii'])