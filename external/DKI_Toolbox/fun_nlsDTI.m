function fun_nlsDTI(inputDWIfold,inputbvalfold,inputbvecfold,inputMaskfold)
...
[D11,D22,D33,D12,D13,D23, S0]=...
    fun_DTI_UNLS_comp_rh(DWI_data,DWI_mask,bval,bvec);
...
Fit_name=[pth, sc, nnname, '_nlsDTI_DT.nii'];
DTnii=V_DWI;
...
Fit_name=[pth, sc, nnname, '_nlsDTI_S0.nii'];
S0nii=V_mask;
...
DTInii.img=DTI;
save_untouch_nii(DTInii,[pth, sc, nnname, '_nlsDTI_DTorient.nii'])