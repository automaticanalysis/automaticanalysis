...
int main(int argc, char *argv[])        
{
  ...
  if ( argc < 4  )     
    { std::cout << "Useage ex:  " << argv[0] << " refimage.ext imagetocopyrefimageinfoto.ext imageout.ext   boolcopydirection  boolcopyorigin boolcopyspacing  {bool-Image2-IsTensor}" << std::endl;
    return 1;
  }           
