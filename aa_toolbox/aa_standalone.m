...
if exist(fullfile(aap.directory_conventions.toolboxes.spm.dir,aap.directory_conventions.T1template),'file')
    aas_log(aap,false,['INFO: T1 template located in ' fullfile(aap.directory_conventions.toolboxes.spm.dir,aap.directory_conventions.T1template)]);
else
    aas_log(aap,true,['T1 template cannot be found in ' fullfile(aap.directory_conventions.toolboxes.spm.dir,aap.directory_conventions.T1template)]);
end
