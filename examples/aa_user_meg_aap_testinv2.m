...
% aap.tasksettings.aamod_emeg_inversion(1).Method='GS';
% aap.tasksettings.aamod_emeg_inversion(2).Method='LOR';
...
%aap.tasksettings.aamod_emeg_sourcecontrasts.Overwrite=1;
% aap.tasksettings.aamod_emeg_source2vol.Overwrite=1;
