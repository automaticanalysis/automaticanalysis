...
aap=aarecipe('aap_parameters_defaults.xml','aap_tasklist_branching_example3.xml');
...
if (ismac)
 aap.acq_details.root = '/Users/rhodri/testaa_branchexample3';
aap.directory_conventions.rawdatadir='/Users/rhodri/rawmridata';
else
 aap.acq_details.root = '/home/rhodri/testaa_branchexample3';
