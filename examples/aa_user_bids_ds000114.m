...
aap = aas_renamestream(aap,'aamod_coreg_extended_2_00001','meanepi','aamod_diffusion_extractnodif_00001.nodif','input');
aap = aas_renamestream(aap,'aamod_coreg_extended_2_00001','epi','dti_FA','input');
aap = aas_renamestream(aap,'aamod_coreg_extended_2_00001','append','dti_AD','input');
aap = aas_renamestream(aap,'aamod_coreg_extended_2_00001','append','dti_RD','input');
